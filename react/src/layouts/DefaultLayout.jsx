                                ...
                                <div className="space-y-1 px-2 pt-2 pb-3 sm:px-3">
                                    {navigation.map((item) => (
                                        <NavLink
                                            ...
                                            as="a"
                                            to={item.to}
                                            className={ (itemCurrent) => classNames(
                                                itemCurrent.isActive ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white',
